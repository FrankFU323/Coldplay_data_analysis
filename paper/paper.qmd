...
This study used the @citeR package to clean and analyze @citedata, including the following packages: @usethis, @tidyverse, @here, @GGally, and @ggplot2, and retrieved the Coldplay dataset using @spotifyr. The R code is adapted from @Rohan.
Coldplay is an English rock band formed by Chris Martin, Jonny Buckland, Guy Berryman, and Will Champion in 1996. Their renowned singles include "Yellow" and "Fix You." Most of their music falls into the genres of rock, pop, and electronic, with recurring themes of love and hope in their lyrics. Albums like Parachutes, A Rush of Blood to the Head, and Viva la Vida are recognized worldwide. Coldplay creates vibrant, interactive live performances, winning numerous Grammy Awards, and continues to influence the global music scene with their emotive, genre-blending sound. In this paper, we aim to conduct an analysis by identifying trends and making comparisons across various aspects of Coldplay's music.

# Graph and Analysis {#sec-Graph_and_Analysis}
The used variables and their measurements see in @sec-appendix.
